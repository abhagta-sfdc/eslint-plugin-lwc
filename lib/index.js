...
const rules = {
    ...
    'no-restricted-browser-globals-during-ssr': require('./rules/ssr/no-restricted-browser-globals'),
    'no-unsupported-ssr-properties': require('./rules/ssr/no-unsupported-properties'),
    'no-node-env-in-ssr': require('./rules/ssr/no-node-env'),
    ...
    'ssr/no-unguarded-async-event': require('./rules/ssr/no-unguarded-async-event'),
